function [P_L,nll_fit,delta,V_R,V_L,P_bound_low,P_bound_high]= MB_RL_function_v5(theta_pred,beta_pred,alpha_pred,...
    Plow_init,boundBias,Octave_used,left_choice_used,inds_correct_used)
