...
SVMSCoreProbofBlock = cell(Num_newAddAreaNums,7);
SampleScore2ProbAlls = cell(Num_newAddAreaNums,1);
AreaPredInfo = cell(Num_newAddAreaNums, 2);
...
AreaPredInfo = [oldSessDataStrc.AreaPredInfo;AreaPredInfo];
SVMSCoreProbofBlock = [oldSessDataStrc.SVMSCoreProbofBlock;SVMSCoreProbofBlock];
SampleScore2ProbAlls = [oldSessDataStrc.SampleScore2ProbAlls;SampleScore2ProbAlls];


%%
save(dataSavePath, 'SVMSCoreProbofBlock', ...
