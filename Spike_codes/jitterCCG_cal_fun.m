function RePeatCCGs = jitterCCG_cal_fun(xTrain1, xTrain2,lag_tau,FR1,FR2, spikeBin, IsShiftCCG, jitterRange)
...
for cRe = 1 : NumOfRepeats    
    ...
    RePeatCCGs(cRe) = CCG_cal_fun(xTrain1, xTrain2_shifts,lag_tau,FR1,FR2, spikeBin, IsShiftCCG);
end
