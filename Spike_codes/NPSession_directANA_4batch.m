...
% clearvar ProbNPSess behavResults PassSoundDatas
% ProbespikeFolder = cSessfolder;
...
ProbNPSess.ksFolder = fullfile(fullfile(ProbespikeFolder,'ks2_5'));
