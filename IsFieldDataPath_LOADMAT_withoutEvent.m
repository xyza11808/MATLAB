function FieldDatas_AllCell = IsFieldDataPath_LOADMAT_withoutEvent(InputPath)
...
%                 EventDataStrc = load(fullfile(InputPath,'AllFieldDatasNew.mat'));
                
%                 FieldDatas_AllCell{cf_field,5} = EventDataStrc.FieldDatas_AllCell{cf_field,5};
                ...
                save CorrCoefDataNew.mat CorrCoefMtx ROICenterPosMtx ROIdis_mtx ROI_Dis_coefData BincentANDdatas ROIdataStrc -v7.3
                %
            catch ME
...
% save(fullfile(InputPath,'AllFieldDatasNew.mat'),'FieldDatas_AllCell','-v7.3');         
