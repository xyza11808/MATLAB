function Outb2r = Green2Orange_2(n, whiteness)
...
b2w = [linspace(0.1,whiteness,TypeNum)' linspace(0.9,whiteness,TypeNum)' linspace(0.1,whiteness,TypeNum)'];
w2r = [linspace(whiteness,0.9,TypeNum)' linspace(whiteness,0.6,TypeNum)' linspace(whiteness,0.2,TypeNum)'];
