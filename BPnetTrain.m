function [HiddenLayerNodeW,HiddenLBias,TrainError] = BPnetTrain(xData,yData,HidNodesNum,nLearnRate)
% training a BP network using customized BP network
