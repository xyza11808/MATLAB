...
% QPBO compilation
cd('QPBO-v1.3.src');
mex -O -largeArrayDims COMPFLAGS="\$COMPFLAGS -Wno-write-strings" QPBO.cpp QPBO_extra.cpp QPBO_maxflow.cpp QPBO_wrapper_mex.cpp QPBO_postprocessing.cpp -output QPBO_wrapper_mex
cd('..');
