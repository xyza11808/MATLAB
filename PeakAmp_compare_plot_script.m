...
WTData_Raw = load(fullfile(WTDataPath,'FieldRawDataSummary.mat'));

TgDataEvent = load(fullfile(TgDataPath,TgDataFn),'MultiSessEventData');
TgSess_EventData_Cell = TgDataEvent.MultiSessEventData;
TgData_Raw = load(fullfile(TgDataPath,'FieldRawDataSummary.mat'));
%%
...
WTData_Raw_Cell = cat(1,WTData_Raw.FieldRawDataAlls{:});
TgData_Raw_Cell = cat(1,TgData_Raw.FieldRawDataAlls{:});
