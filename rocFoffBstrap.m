function varargout=rocFoffBstrap(varargin)
...
if ubar > hbar
    %invert area value to real value according to real distribution
        Area = 1 - Area;
end

if nargout >= 2
    varargout{1} = Area; %Area under the curve
    varargout{2} = ubar > hbar; %label upside down logical inds
