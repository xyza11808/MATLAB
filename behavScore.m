function behavScore
FilePath=input('please input the data path where you behavior data saved.\n','s');
cd(FilePath);
data_save_path='./session_data_plots';
...
title_name={fn(1:end-4);behavResults.Stim_Type(1,:)};
title(title_name,'fontsize',20,'interpreter','none');

saveas(gcf,sprintf('./session_data_plots/plot_%s.png', fn(1:end-4)), 'png')
close;
end
%%
