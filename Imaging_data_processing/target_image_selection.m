...
cd('H:\data\batch\batch27_PV\20160430\anm03\test01\channel1');
[im, ~] = load_scim_data('b27a03_test01_3x_2afc_195um_20160430_c1_083.tif');
colormap gray;
selectframe=im(:,:,1:50);
...
%
% % % 
dir_imreg_src = 'H:\data\batch\batch27_PV\20160430\anm03\test02';
dir_imreg_dest = [dir_imreg_src filesep 'im_data_reg_cpu'];
dft_reg_dir_2_zy(dir_imreg_src, dir_imreg_dest, [], im_reg_target)
% 
