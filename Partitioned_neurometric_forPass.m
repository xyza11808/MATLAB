...
%% plots the prediction score result and real behavior data, using overall averaged stimulus response data
% may cause some overlapping, since same population of data was used in
...
saveas(hScoref,'PredScore overfit psychometric curve plots');
saveas(hScoref,'PredScore overfit psychometric curve plots','png');
close(hScoref);
...
save NeuroCurveVSBehav.mat StimOctaveTypes AvgUsedTestRPRob StimRProb PredRightwardPerfMean CurTestScorFit PerfFit PredScoreOctMtx -v7.3
%%
