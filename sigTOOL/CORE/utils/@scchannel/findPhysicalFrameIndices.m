function [idx epochs trigger]=findPhysicalFrameIndices(channel, trigger, duration, pretime)
% findPhysicalFrameIndices returns the indices of valid frames
% 
% Example:
% [idx epochs trigger]=findPhysicalFrameIndices(channel, trigger, duration, pretime)
% where
...
epochs=findPhysicalEpochs(channel, trig2);

trig3=trig2+duration;
epochs2=findPhysicalEpochs(channel, trig3);
