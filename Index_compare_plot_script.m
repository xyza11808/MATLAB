...
h = scatterhist(ClIndex2afcP, ClIndexrfP,'Location','NorthEast','Direction','out','color','k','Linewidth',2,'NBins',[20,20],...
    'LineStyle',{'-'},'MarkerSize',14,'Kernel','overlay');
set(h(1),'FontSize',16)
...
h = scatterhist(TuDIndex2afcP, TuDIndexrfP,'Location','NorthEast','Direction','out','color','k','Linewidth',2,'NBins',[20,20],...
    'LineStyle',{'-'},'MarkerSize',14,'Kernel','overlay');
set(h(1),'FontSize',16)
set(h(1),'XAxisLocation','bottom','YAxisLocation','left')
set(h(1),'xtick',0:0.2:1,'ytick',0:0.2:1)
