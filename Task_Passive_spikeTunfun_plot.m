...
% loading task data
[Taskfn,Taskfp,Taskfi] = uigetfile('EstimateSPsave.mat','Please select the task data file');
if ~Taskfi
    return;
end
...
[Passfn,Passfp,Passfi] = uigetfile('EsSpikeSave.mat','Please select the passive data file');
if ~Passfi
    return;
end
