function varargout=RandNeuroMPCoption(RawDataAll,StimAll,TrialResult,AlignFrame,FrameRate,varargin)
...
% number of PCs is optional for current function, default for using PCs
% number large than 90% of total numbers
