function [ROCout,LabelMeanS]=rocOnlineHout(varargin)
...
LabelMeanS.LType1value=[InputLabelType(1),ubar];
LabelMeanS.LType2value=[InputLabelType(2),hbar];
