...
load('CSessionData.mat', 'frame_lickAllTrials','FRewardLickT','frame_rate','start_frame');
% DataRaw = data;
% try
...
TrAnsFTimeNM = round((NMFlickT(:)/1000)*frame_rate);
...
%             if ~sum(TrainRespDataMtx)
                cvmdfit = cvglmnet(BehavParaMtx,TrainRespDataMtx,'poisson',options,[],10);
...
%%
save SPDataBehavCoefSaveOffFlick.mat ROIAboveThresInds AllROIData -v7.3
%%
% cROI = 28;
